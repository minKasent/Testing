...
class OrganizationValidationTest {
    ...
    class OrgNameValidationTests {
        ...
        void tc013_orgName_empty_shouldFail() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
            assertThat(violations).anyMatch(v -> v.getPropertyPath().toString().equals("orgName"));
        }

        @Test
        @DisplayName("TC014: OrgName - Null value - Fail")
        void tc014_orgName_null_shouldFail() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName(null).build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
            assertThat(violations).anyMatch(v -> v.getPropertyPath().toString().equals("orgName"));
        }
        ...
        void tc015_orgName_length2_shouldFail() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("AB").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
            assertThat(violations).anyMatch(v -> v.getPropertyPath().toString().equals("orgName") && v.getMessage().contains("3"));
        }

        @Test
        @DisplayName("TC016: OrgName - Length = 3 (minimum boundary) - Pass")
        void tc016_orgName_length3_shouldPass() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("ABC").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
        ...
        void tc017_orgName_length255_shouldPass() {
            ...
            OrganizationDTO dto = OrganizationDTO.builder().orgName(name255).build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isEmpty();
        }
        ...
        void tc018_orgName_length256_shouldFail() {
            ...
            OrganizationDTO dto = OrganizationDTO.builder().orgName(name256).build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
            assertThat(violations).anyMatch(v -> v.getPropertyPath().toString().equals("orgName"));
        }
    ...
    @Nested
    @DisplayName("TC019-TC024: Phone Validation Tests")
    class PhoneValidationTests {

        @Test
        @DisplayName("TC019: Phone - Empty value (optional) - Pass")
        void tc019_phone_empty_shouldPass() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").phone("").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isEmpty();
        }
        ...
        void tc020_phone_length8_shouldFail() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").phone("12345678").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
        ...
        void tc021_phone_length9_shouldPass() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").phone("123456789").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isEmpty();
        }
        ...
        void tc022_phone_length12_shouldPass() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").phone("123456789012").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isEmpty();
        }
        ...
        void tc023_phone_length13_shouldFail() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").phone("1234567890123").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
            assertThat(violations).anyMatch(v -> v.getPropertyPath().toString().equals("phone"));
        }
        ...
        void tc024_phone_invalidFormat_shouldFail(String invalidPhone) {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").phone(invalidPhone).build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
            assertThat(violations).anyMatch(v -> v.getPropertyPath().toString().equals("phone"));
        }
    ...
    class EmailValidationTests {
        ...
        void tc025_email_empty_shouldPass() {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").email("").build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
        ...
        void tc026_email_validFormat_shouldPass(String validEmail) {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").email(validEmail).build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isEmpty();
        }
        ...
        void tc027_email_invalidFormat_shouldFail(String invalidEmail) {
            OrganizationDTO dto = OrganizationDTO.builder().orgName("Valid Org").email(invalidEmail).build();
            Set<ConstraintViolation<OrganizationDTO>> violations = validator.validate(dto);
            assertThat(violations).isNotEmpty();
